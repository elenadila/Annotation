...
#------------------------------------------------------------------------------------------------------------------------------------------#
    ...
    """ Step 1: Extract the experiment informations and create a file with start, end, duration of each stimulus """
...
#-----------------------------------------------------------------------------------------------------------------------------------------#
    ...
    for participant in range(0,len(user)):
      for file in range(0, len(annotation_files)):
            ...
            annotation_converter.annotation_time_converter(dir + user[participant], dir + user[participant] + annotation_files[file])
